...
/* PICU_3 Address: CYDEV_PICU_INTTYPE_PICU3_BASE Size (bytes): 8 */
#define BS_PICU_3_VAL ((const uint8 CYFAR *)0x480002A4u)

/* IOPORT_7 Address: CYDEV_PRTDSI_PRT12_BASE Size (bytes): 6 */
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x480002ACu)

/* UDB_0_1_1_CONFIG Address: CYDEV_UCFG_B1_P4_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)0x480002B4u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000354u)
...
void cyfitter_cfg(void)
{
...

	{
		...
		static const cfg_memcpy_t CYCODE cfg_memcpy_list [] = {
			/* dest, src, size */
			{(void CYFAR *)(CYDEV_PICU_INTTYPE_PICU3_BASE), BS_PICU_3_VAL, 8u},
